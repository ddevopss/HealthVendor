...
class SigningConfigAWS extends NativeResource
{
    ...
    public function __construct(array $options = [])
    {
        ...
        self::$crt->signing_config_aws_set_algorithm(
            $sc,
            $options->algorithm->asInt()
        );
        self::$crt->signing_config_aws_set_signature_type(
            $sc,
            $options->signature_type->asInt()
        );
        if (
