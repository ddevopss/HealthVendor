...
final class CredentialsTest extends CrtTestCase
{
    public function testEmptyCredentials()
    {
        ...
        $this->assertNotNull(
            $creds,
            "Failed to create default/empty credentials"
        );
        $creds = null;
    }
    ...
    public function testCredentialsLifetime()
    {
        ...
        $this->assertEquals(
            $creds->expiration_timepoint_seconds,
    ...
    private function getCredentialsConfig()
    {
        ...
        $options["secret_access_key"] =
            "TESTSECRETaccesskeyThatDefinitelyDoesntWork";
    ...
    public function testStaticCredentialsProviderLifetime()
    {
        ...
        $this->assertNotNull(
            $provider,
            "Failed to create StaticCredentialsProvider"
        );
        $provider = null;
    }
}
