...
final class SigningTest extends CrtTestCase
{
    ...
    public function testConfigAWSLifetime()
    {
        ...
        $this->assertNotNull(
            $config,
            "Failed to create default SigningConfigAWS"
        );
        $config = null;
    }
    ...
    public function testConfigAWSConstructionWithOptions()
    {
        ...
        $this->assertNotNull(
            $config,
            "Failed to create SigningConfigAWS with custom options"
        );
        $config = null;
    }
    ...
    public function testSignableFromHttpRequestLifetime()
    {
        ...
        $this->assertNotNull(
            $signable,
            "Failed to create Signable from HTTP::Request"
        );
        $signable = null;
    }
    ...
    public function testSignableFromChunkLifetime()
    {
        ...
        $this->assertNotNull(
            $signable,
            "Failed to create Signable from chunk stream"
        );
        $signable = null;
    }
    ...
    {
        $canonical_request =
            "THIS IS A CANONICAL_REQUEST. IT IS DEEPLY CANONICAL";
        $signable = Signable::fromCanonicalRequest($canonical_request);
        $this->assertNotNull(
            $signable,
            "Failed to create Signable from canonical request"
        );
        $signable = null;
    }
    ...
    public function testShouldSignHeader()
    {
        ...
        $this->assertNotNull(
            $http_request,
            "Unable to create HttpRequest for signing"
        );
        $signable = Signable::fromHttpRequest($http_request);
        $this->assertNotNull(
            $signable,
            "Unable to create signable from HttpRequest"
        );
